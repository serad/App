         ...
         $.ajax({
             ...
             success: function(response) {
                 for (i in response) {
                     ...
                     if (jQuery.type(evento) == 'object') $('#calendar').fullCalendar('renderEvent', evento);
                 }
             }
         });
     }
     ...
     function guardaEventos() {
         ...
         for (i in z) {
             eventos[i] = {
                 start: $.datepicker.formatDate('yy-mm-dd', new Date(z[i]['_start']['_d'])),
                 end: $.datepicker.formatDate('yy-mm-dd', new Date(z[i]['_end']['_d'])),
                 title: z[i]['title']
             }
